...
public class SummerHolidayCourseActivity extends Activity {
    private String token;
    private int summerCourse = 2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_summer_holiday_course);
    ...
    private void initDate() {
        ...
        rp.put("type", summerCourse);
        rp.put("token", token);
        rp.put("sub", sub);
        Log.d("type+token+sub===>>>", summerCourse + "+" + token + "+" + sub);
        final Dialog mLoadingDialog = DialogCreator.createLoadingDialog(SummerHolidayCourseActivity.this,
                null);
        mLoadingDialog.show();
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    if (code == 1000) {
                        ...
                        Toast.makeText(SummerHolidayCourseActivity.this, object.getString("msg"), Toast.LENGTH_LONG).show();
                        return;
                    } else if (code == 0) {
                        ...
                        mLoadingDialog.dismiss();
                        SimpleAdapter adapter = new SimpleAdapter(SummerHolidayCourseActivity.this, getList(courses, coursesid),
                        ...
                        grid_course.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view,
                                ...
                                Intent intent = new Intent(SummerHolidayCourseActivity.this, CourseVersionActivity.class);
                                Bundle bundle = new Bundle();
                                bundle.putInt("version", summerCourse);
