...
public class SynchronizeCourseActivity extends Activity {
    ...
    private int synchronizeCourse = 3;
    ...
    private void initDate() {
        ...
        rp.put("type", synchronizeCourse);
        rp.put("token", token);
        rp.put("sub", sub);
        Log.d("type+token+sub===>>>", synchronizeCourse + "+" + token + "+" + sub);
        final Dialog mLoadingDialog = DialogCreator.createLoadingDialog(SynchronizeCourseActivity.this,
                null);
        mLoadingDialog.show();
                    ...
                    if (code == 1000) {
                        ...
                        grid_course.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view,
                                ...
                                Intent intent = new Intent(SynchronizeCourseActivity.this, CourseVersionActivity.class);
                                Bundle bundle = new Bundle();
                                bundle.putInt("version", synchronizeCourse);
